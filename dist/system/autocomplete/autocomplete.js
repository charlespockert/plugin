System.register(['aurelia-framework', '../common/events', '../common/options', 'jquery', 'kendo-ui/src/kendo.autocomplete'], function (_export) {
    'use strict';
    ...
    return {
        setters: [function (_aureliaFramework) {
            ...
            $ = _jquery['default'];
        }, function (_kendoUiSrcKendoAutocomplete) {}],
        execute: function () {
